...
type FallingPatternProps = React.ComponentProps<"div"> & {
  /** Primary color of the falling elements (default: matches primary brand) */
  color?: string;
  /** Background color */
  backgroundColor?: string;
  /** Animation duration in seconds (default: 150) */
  duration?: number;
  /** Blur intensity for the overlay (default: '1em') */
  blurIntensity?: string;
  /** Pattern density — affects overlay dot spacing (default: 1) */
  density?: number;
};

/** Full-viewport falling rain-like pattern background. */
