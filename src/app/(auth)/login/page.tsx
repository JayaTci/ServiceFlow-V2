  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-[45%] xl:w-1/2 relative overflow-hidden mesh-bg flex-col justify-between p-10">
        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-white/60 text-base leading-relaxed max-w-sm">
              One place for your team to submit, track, and resolve every internal request — from
              IT support to document processing.
            </p>
          </div>
        ...
        <p className="text-white/30 text-xs relative z-10">© {new Date().getFullYear()} ServiceFlow</p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-background">
        <div className="w-full max-w-sm space-y-7">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-muted-foreground">Access your service request dashboard</p>
          </div>
